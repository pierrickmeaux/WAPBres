...
\begin{equation*}
    \left(\sum_{y_i \in \vecy_{\{1\}}} y_i\right) \cdot 2^{i_1} + \left(\sum_{y_i \in \vecy_{\{2\}}} y_i\right) \cdot 2^{i_2} + \ldots + \left(\sum_{y_i \in \vecy_{\{t\}}} y_i\right) \cdot 2^{i_t} = 0.
\end{equation*}
...
\begin{equation*}
    \begin{split}
        &\left(\sum_{y_i \in \vecy_{\{1\}}} y_i\right) \cdot 2^{i_1} + \left(\sum_{y_i \in \vecy_{\{2\}}} y_i\right) \cdot 2^{i_2} + \ldots + \left(\sum_{y_i \in \vecy_{\{t\}}} y_i\right) \cdot 2^{i_t} +\\
        &2\left(\sum_{y_i \in \vecy_{\{1,2\}}} y_i\right) \cdot 2^{i_1 + i_2} + 2\left(\sum_{y_i \in \vecy_{\{1,3\}}} y_i\right) \cdot 2^{i_1 + i_3} + \ldots + 2\left(\sum_{y_i \in \vecy_{\{t-1, t\}}} y_i\right) \cdot 2^{i_{t-1} + i_{t}} = 0.
    \end{split}
\end{equation*}
We use the previously defined notations and knowledge that $s_1 = s_2 = \ldots = s_t = 0$
to simplify it into
\begin{equation}\label{eq:lin_t_row2}
    2s_{12} \cdot 2^{i_1 + i_2} + 2s_{13} \cdot 2^{i_1 + i_3} + \ldots + 2s_{(t-1)(t)} \cdot 2^{i_{t-1} + i_{t}} = 0.
\end{equation}
Because $\vecy$ is balanced, it is clear that any $s_j$ can take for values any even number or its opposite
...
\begin{equation*}
    \begin{split}
        \mu_1 s_1 2^{i_1} + \ldots + \mu_t s_t 2^t &+\\
        \mu_{12} s_{12} 2^{i_1 + i_2} + \ldots + \mu_{(t-1)(t)} s_{(t-1)(t)}+ 2^{i_{t-1} + i_{t}} &+\\
        \ldots &+\\
        \mu_{12\ldots r} s_{12\ldots r} 2^{i_1 + i_2 + \ldots + i_r} + \ldots + \mu_{(t-r)(t-r+1)\ldots(t)} s_{(t-r)(t-r+1)\ldots(t)} \cdot 2^{i_{t-r} + i_{t-r+1} + \ldots + i_{t}} &= 0
    \end{split}
\end{equation*}
