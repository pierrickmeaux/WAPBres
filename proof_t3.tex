\begin{proof}
    ...
    or 0 but by applying the constraint of balancedness from row 0, all possible
    $\binom{8}{4}$ balanced $\mathbf{y}$ exhibit only five possible multisets of
    values for $s_1, s_2$ and $s_3$ i.e.:
    ...
    \begin{itemize}
        ...
        \item $\{0, 0, \pm4\}$
    \end{itemize}
    It is trivial that any multiset with identical non-zero values can't satisfy
    Equation \ref{eq:lin_t=3_row2} since $i_1 < i_2 < i_3$. Therefore, the condition
    ...
    works is $y_{011} = y_{101} = y_{110} = -y_{111}$. The solutions that verify Equation \ref{eq:lin_t=3_row3} are given by
    $$
