...
\appendix
\pmnote{Martin: I add our work with Chunlei here. The proof covers only half of the statement for now: From left to a middle statement.\\ I believe the same middle statement can be reached from the right hand side of the equivalence to complete the proof.}
\section{Equivalence to the conjecture.}
\include{conjecture_equivalence.tex}
