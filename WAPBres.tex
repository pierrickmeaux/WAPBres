...
\begin{theorem}\label{Th_K_V_matrices}
	Let $\matK$ be the Krawtchouk matrix and $\matV$ be the Vandemonde matrix given by $V_{k,\ell} =\ell^k$ with $0\leq k,\ell\leq n$ indexing the rows and columns, respectively.
