...
\begin{theorem}\label{prop:WalsCorr}
...
Therefore,  Theorem~\ref{prop:WalsCorr} can be reformulated as follows. 

\begin{theorem}\label{prop_t_corrector_Vandemonde_matrix}
...
\begin{proof}
	...
	By Theorem~\ref{prop_t_corrector_Vandemonde_matrix} we see that $\corr(f) = 1$ if and only if
	\[
